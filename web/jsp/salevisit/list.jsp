										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>业务员名称：</TD>
													<TD>
														<input type="hidden" name="user.user_id" id="user_id" value="${param['user.user_id']}" />
														<INPUT class=textbox style="WIDTH: 80px" maxLength=50 name="user_name"  id="user_name" value="${param['user_name']}" >
														<input type="button" value="选择业务员" onclick="window.open('${pageContext.request.contextPath}/UserAction_list','','width=600,height=300')" />
													</TD>
