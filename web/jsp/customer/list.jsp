									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<select name="pageSize" onchange="changePageSize($('#pageSizeSelect option:selected').val())" id="pageSizeSelect">
													...
													<option value="8" <s:property value="#pageBean.pageSize==8?'selected':''"/> >8</option>
												</select>
												条
												...
												到
												<input type="text" size="5" id="page" name="page" value="<s:property value="#pageBean.currentPage" />"  />
												页
